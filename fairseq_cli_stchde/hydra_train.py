...
from fairseq_stchde.dataclass.initialize import add_defaults, hydra_init
from fairseq_cli_stchde.train import main as pre_main
from fairseq_stchde import distributed_utils, metrics
