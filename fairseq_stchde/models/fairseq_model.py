...
from fairseq_stchde.data import Dictionary
from fairseq_stchde.dataclass.utils import (
    convert_namespace_to_omegaconf,
    gen_parser_from_dataclass,
)
from fairseq_stchde.models import FairseqDecoder, FairseqEncoder
...
class BaseFairseqModel(nn.Module):
    ...
    def load_state_dict(
        ...
        from fairseq_stchde.checkpoint_utils import prune_state_dict
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        """
        Load a :class:`~fairseq_stchde.models.FairseqModel` from a pre-trained model
        file. Downloads and caches the pre-trained model file if needed.

        The base implementation returns a
        :class:`~fairseq_stchde.hub_utils.GeneratorHubInterface`, which can be used to
        generate translations or sample from language models. The underlying
        :class:`~fairseq_stchde.models.FairseqModel` can be accessed via the
        *generator.models* attribute.
        ...
        Args:
            ...
            data_name_or_path (str, optional): point args.data to the archive
                ...
                model archive path.
        """
        from fairseq_stchde import hub_utils
