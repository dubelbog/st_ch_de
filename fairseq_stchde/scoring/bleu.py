...
from fairseq_stchde.scoring import BaseScorer, register_scorer
from fairseq_stchde.scoring.tokenizer import EvaluationTokenizer
...
class Scorer(object):
    def __init__(self, cfg):
        ...
        try:
            from fairseq_stchde import libbleu
