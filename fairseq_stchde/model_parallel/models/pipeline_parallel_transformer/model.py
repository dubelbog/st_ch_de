...
from fairseq_stchde.model_parallel.models.pipeline_parallel_transformer.layers import (
    Embedding,
...
from fairseq_stchde.models import (
    BaseFairseqModel,
    FairseqDecoder,
    FairseqEncoder,
    register_model,
...
from fairseq_stchde.models.fairseq_encoder import EncoderOut
from fairseq_stchde.models.transformer import (
    base_architecture,
    transformer_iwslt_de_en,
    transformer_wmt_en_de_big,
)
from fairseq_stchde.modules import SinusoidalPositionalEmbedding
...
class TransformerEncoder(FairseqEncoder):
    ...
    Args:
        ...
        dictionary (~fairseq_stchde.data.Dictionary): encoding dictionary
...
class TransformerDecoder(FairseqDecoder):
    ...
    Args:
        args (argparse.Namespace): parsed command-line arguments
        dictionary (~fairseq_stchde.data.Dictionary): decoding dictionary
    ...
    def upgrade_state_dict_named(self, state_dict, name):
        """Upgrade a (possibly old) state dict for new versions of fairseq_stchde."""
