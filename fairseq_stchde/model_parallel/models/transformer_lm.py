...
from fairseq_stchde.model_parallel.models.transformer import ModelParallelTransformerDecoder
from fairseq_stchde.models import register_model, register_model_architecture
from fairseq_stchde.models.transformer_lm import TransformerLanguageModel


try:
    from fairseq_stchde.model_parallel.megatron.mpu import VocabParallelEmbedding
