...
from fairseq_stchde.dataclass.configs import FairseqConfig
...
def override_module_args(args: Namespace) -> Tuple[List[str], List[str]]:
    ...
    if args is not None:
        if hasattr(args, "task"):
            from fairseq_stchde.tasks import TASK_DATACLASS_REGISTRY
        ...
        from fairseq_stchde.registry import REGISTRIES
        ...
        if hasattr(args, "arch"):
            from fairseq_stchde.models import ARCH_MODEL_REGISTRY, ARCH_MODEL_NAME_REGISTRY
...
def convert_namespace_to_omegaconf(args: Namespace) -> DictConfig:
    ...
    if cfg.lr_scheduler is None and getattr(args, "lr_scheduler", None):
        ...
        from fairseq_stchde.optim.lr_scheduler import LR_SCHEDULER_REGISTRY
    ...
    if cfg.criterion is None and getattr(args, "criterion", None):
        ...
        from fairseq_stchde.criterions import CRITERION_REGISTRY
