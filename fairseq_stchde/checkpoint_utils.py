...
import torch
from fairseq_stchde.dataclass.configs import CheckpointConfig, FairseqConfig
...
def load_model_ensemble(
    ...
    Args:
        ...
        task (fairseq_stchde.tasks.FairseqTask, optional): task to use for loading
    """
    assert not (
...
def load_model_ensemble_and_task(
    ...
    from fairseq_stchde import tasks
...
def _upgrade_state_dict(state):
    ...
    from fairseq_stchde import models, registry, tasks
