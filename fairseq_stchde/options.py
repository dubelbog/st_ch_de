...
from fairseq_stchde.dataclass.configs import (
    CheckpointConfig,
    CommonConfig,
    CommonEvalConfig,
    DatasetConfig,
...
from fairseq_stchde.utils import csv_str_list, eval_bool, eval_str_dict, eval_str_list  # noqa
...
def parse_args_and_arch(
    ...
    from fairseq_stchde.models import ARCH_MODEL_REGISTRY, ARCH_CONFIG_REGISTRY, MODEL_REGISTRY
    ...
    if getattr(args, "use_bmuf", False):
        ...
        from fairseq_stchde.optim.bmuf import FairseqBMUF
