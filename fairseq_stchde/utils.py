...
from fairseq_stchde.modules.multihead_attention import MultiheadAttention
...
def load_ensemble_for_inference(filenames, task, model_arg_overrides=None):
    from fairseq_stchde import checkpoint_utils
...
def replace_unk(hypo_str, src_str, alignment, align_dict, unk):
    from fairseq_stchde import tokenizer
...
def get_activation_fn(activation: str) -> Callable:
    ...
    from fairseq_stchde.modules import gelu, gelu_accurate
