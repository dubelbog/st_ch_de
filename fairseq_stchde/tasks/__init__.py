...
from fairseq_stchde.dataclass.utils import merge_with_parent, populate_dataclass
...
def register_task(name, dataclass=None):
    ...
    :func:`~fairseq_stchde.tasks.register_task` function decorator.
    ...
    .. note::
        ...
        All Tasks must implement the :class:`~fairseq_stchde.tasks.FairseqTask`
        interface.
...
for file in os.listdir(tasks_dir):
    ...
    if (
        ...
        module = importlib.import_module("fairseq_stchde.tasks." + task_name)
