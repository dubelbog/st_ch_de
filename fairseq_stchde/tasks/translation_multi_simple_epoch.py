...
from fairseq_stchde.data.multilingual.multilingual_data_manager import (
    MultilingualDatasetManager,
)
from fairseq_stchde.data.multilingual.sampling_method import SamplingMethod
from fairseq_stchde.tasks import LegacyFairseqTask, register_task
from fairseq_stchde.utils import FileContentsAction
...
class TranslationMultiSimpleEpochTask(LegacyFairseqTask):
    ...
    Args:
        ...
        dicts (Dict[str, fairseq_stchde.data.Dictionary]): mapping from supported languages to their dictionaries
    ...
    .. argparse::
        :ref: fairseq_stchde.tasks.translation_parser
        :prog:
    """
