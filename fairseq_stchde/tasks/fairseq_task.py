...
import torch
from fairseq_stchde import metrics, search, tokenizer, utils
from fairseq_stchde.data import Dictionary, FairseqDataset, data_utils, encoders, iterators
from fairseq_stchde.dataclass import FairseqDataclass
from fairseq_stchde.dataclass.utils import gen_parser_from_dataclass
...
class FairseqTask(object):
    ...
    def dataset(self, split):
        ...
        Returns:
            a :class:`~fairseq_stchde.data.FairseqDataset` corresponding to *split*
        """
        from fairseq_stchde.data import FairseqDataset
    ...
    def build_criterion(self, cfg: DictConfig):
        """
        Build the :class:`~fairseq_stchde.criterions.FairseqCriterion` instance for
        this task.
        ...
        Returns:
            a :class:`~fairseq_stchde.criterions.FairseqCriterion` instance
        """
        from fairseq_stchde import criterions
    ...
    def build_generator(
        ...
        if getattr(args, "score_reference", False):
            from fairseq_stchde.sequence_scorer import SequenceScorer
        ...
        from fairseq_stchde.sequence_generator import (
            SequenceGenerator,
            SequenceGeneratorWithAlignment,
        )
        try:
            from fairseq_stchde.fb_sequence_generator import FBSequenceGenerator
    ...
    def train_step(
        ...
        Args:
            sample (dict): the mini-batch. The format is defined by the
                :class:`~fairseq_stchde.data.FairseqDataset`.
            model (~fairseq_stchde.models.BaseFairseqModel): the model
