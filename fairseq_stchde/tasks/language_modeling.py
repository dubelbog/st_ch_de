...
class LanguageModelingTask(LegacyFairseqTask):
    ...
    Args:
        dictionary (~fairseq_stchde.data.Dictionary): the dictionary for the input of
            the language model
        output_dictionary (~fairseq_stchde.data.Dictionary): the dictionary for the
    ...
    .. argparse::
        :ref: fairseq_stchde.tasks.language_modeling_parser
        :prog:
    """
    ...
    def source_dictionary(self):
        """Return the :class:`~fairseq_stchde.data.Dictionary` for the language
        model."""
