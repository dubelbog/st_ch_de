...
from fairseq_stchde.incremental_decoding_utils import with_incremental_state
from fairseq_stchde.modules.fairseq_dropout import FairseqDropout
from fairseq_stchde.modules.unfold import unfold1d
...
def LightweightConv(
    ...
    if torch.cuda.is_available():
        try:
            from fairseq_stchde.modules.lightconv_layer import LightconvLayer
