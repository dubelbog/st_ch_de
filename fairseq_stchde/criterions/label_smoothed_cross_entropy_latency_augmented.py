...
from examples_stchde.latency import LatencyTraining
from fairseq_stchde.criterions import register_criterion
from fairseq_stchde.criterions.label_smoothed_cross_entropy import (
