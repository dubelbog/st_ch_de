...
import torch
from fairseq_stchde import optim
...
class _FP16OptimizerMixin(object):
    ...
    def backward(self, loss):
        ...
        Compared to :func:`fairseq_stchde.optim.FairseqOptimizer.backward`, this
...
class MemoryEfficientFP16Optimizer(
    ...
    Compared to :class:`fairseq_stchde.optim.FP16Optimizer`, this version does not
