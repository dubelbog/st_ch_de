...
import numpy as np
import torch
from fairseq_stchde.dataclass.constants import DATASET_IMPL_CHOICES
from fairseq_stchde.data.fasta_dataset import FastaDataset
...
def make_dataset(path, impl, fix_lua_indexing=False, dictionary=None):
    if impl == "raw" and IndexedRawTextDataset.exists(path):
        ...
        from fairseq_stchde.data.fasta_dataset import EncodedFastaDataset
