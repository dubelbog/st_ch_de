...
class BacktranslationDataset(FairseqDataset):
    ...
    Args:
        tgt_dataset (~fairseq_stchde.data.FairseqDataset): the dataset to be
            backtranslated. Only the source side of this dataset will be used.
            After backtranslation, the source sentences in this dataset will be
            returned as the targets.
        src_dict (~fairseq_stchde.data.Dictionary): the dictionary of backtranslated
            sentences.
        tgt_dict (~fairseq_stchde.data.Dictionary, optional): the dictionary of
            sentences to be backtranslated.
        backtranslation_fn (callable, optional): function to call to generate
            backtranslations. This is typically the `generate` method of a
            :class:`~fairseq_stchde.sequence_generator.SequenceGenerator` object.
