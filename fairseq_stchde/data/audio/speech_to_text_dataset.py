...
from fairseq_stchde.data.audio.audio_utils import get_fbank, get_waveform
from fairseq_stchde.data.audio.feature_transforms import CompositeAudioFeatureTransform
...
class S2TDataConfig(object):
    ...
    def pre_tokenizer(self) -> Dict:
        ...
        Tokenizers are defined in `fairseq_stchde.data.encoders.*`"""
