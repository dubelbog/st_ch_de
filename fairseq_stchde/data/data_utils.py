...
def load_indexed_dataset(
    ...
    Args:
        ...
        dictionary (~fairseq_stchde.data.Dictionary): data dictionary
    ...
    """
    import fairseq_stchde.data.indexed_dataset as indexed_dataset
...
def batch_by_size(
    ...
    """
    try:
        from fairseq_stchde.data.data_utils_fast import (
            batch_by_size_fn,
            batch_by_size_vec,
