...
import numpy as np
import torch
from fairseq_stchde.data import FairseqDataset, plasma_utils
from fairseq_stchde.data.indexed_dataset import best_fitting_int_dtype
...
class TokenBlockDataset(FairseqDataset):
    ...
    def _build_slice_indices(
        ...
        try:
            from fairseq_stchde.data.token_block_utils_fast import (
